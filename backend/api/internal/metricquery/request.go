...
var metricCatalog = map[string]struct{}{
	...
	"sentinel_collector_icmp_rtt_seconds_count":        {},
	"sentinel_collector_icmp_rtt_seconds_sum":          {},
	"sentinel_collector_icmp_loss_ratio":               {},
	"sentinel_collector_tcp_connect_seconds":           {},
	"sentinel_collector_tcp_connect_seconds_bucket":    {},
	"sentinel_collector_tcp_connect_seconds_count":     {},
	"sentinel_collector_tcp_connect_seconds_sum":       {},
	"sentinel_collector_http_response_seconds":         {},
	"sentinel_collector_http_response_seconds_bucket":  {},
	"sentinel_collector_http_response_seconds_count":   {},
	"sentinel_collector_http_response_seconds_sum":     {},
	"sentinel_collector_dns_resolve_seconds":           {},
	"sentinel_collector_dns_resolve_seconds_bucket":    {},
	"sentinel_collector_dns_resolve_seconds_count":     {},
	"sentinel_collector_dns_resolve_seconds_sum":       {},
