...
Run `./scripts/pcap-summary.sh file.pcapng` for a reproducible text/CSV summary before opening Wireshark. Opening a file locally never depends on a server stack.
