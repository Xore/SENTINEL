...
## Research Backlog Item — Gap #3 from `docs/gap-analysis/gap-analysis-collector-vs-standalone.md`
...
> **Scope:** Formal basis of the method, its stated scale assumptions, the specific numerical-stability risks at small N, and a concrete validation procedure using this project's own historical data before enabling in production, per `docs/gap-analysis/research-guide-for-gap-topics.md` §5.
